...
for i=1,opt.maxepoch - 1 do
	filename[i] = string.format("/home/arjun/mohak/lstm/feature_vector_fwd_%d.t7",i)
end
...
--local trainBatches = 0.003 * nBatches
--local validBatches = 0.005 * nBatches
...
for th=1,9 do
	...
	filen = string.format("/home/arjun/mohak/lstm/feature_vector_fwd_%d.t7",epoch)
	print("Threshold "..th)
