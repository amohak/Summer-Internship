...
for i=1,opt.maxepoch - 1 do
	filename[i] = string.format("/home/arjun/mohak/lstm/murphy_bwd_%d.t7",i)
end
...
--local trainBatches = 0.004 * nBatches
--local validBatches = 0.006 * nBatches
...
for th=1,9 do
	...
	filen = string.format("/home/arjun/mohak/lstm/murphy_bwd_%d.t7",epoch)
	print("Threshold "..th)
